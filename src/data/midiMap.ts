...
export const midiMap = (cc: number) : {group: string, key: string} => {
    const map: Map = {
        1: {group: 'dialPosition', key: 'x'},
        2: {group: 'dialPosition', key: 'y'},
        3: {group: 'dialPosition', key: 'z'},
        ...
        9: {group: 'leftB', key: 'freq'},
        10: {group: 'leftB', key: 'volume'},
        11: {group: 'leftB', key: 'reverb'},
        12: {group: 'leftB', key: 'modulationIndex'},
        13: {group: 'leftB', key: 'harmonicity'},
