...
export const midiMap = (cc: number) : {key: string, type: string, valuesI?: number} => {
    const map: Map = {
        ...
        7: {key: 'yParams', type: 'custom1', valuesI: 0},
        8: {key: 'yParams', type: 'custom2', valuesI: 0},
        9: {key: 'yParams', type: 'custom3', valuesI: 0},
        ...
        19: {key: 'yParams', type: 'custom1', valuesI: 1},
        20: {key: 'yParams', type: 'custom2', valuesI: 1},
        21: {key: 'yParams', type: 'custom3', valuesI: 1},
